      ...
      return (
        <View style={styles.container}>
          ...
          <View style={styles.welcomeTexts}>
            ...
            <Text style={[styles.bodyText, {marginTop: "2%"}]}>You can schedule reminders, or be notified when leaving a location.</Text>
            <Text style={[styles.bodyText, {marginTop: "5%"}]}>Examples: </Text>
            <Text style={[styles.bodyText, {fontFamily: "Montserrat_400Regular_Italic"}]}>"Bring inhaler to soccer practice at 6:30pm on Tuesdays", or </Text>
